...
DEFAULT_CONFIG = {
    "host_usernames": ["sahar.mh"],
    "admin_usernames": ["sahar.mh"],
    "vip_usernames": [],
    "banned_users": [],
    "teleport_locations": {
...
async def main():
    ...
    room_id = os.getenv("ROOM_ID", "6999adf29c779d3cdf4da454")
    api_token = os.getenv("API_TOKEN", "b773684c5666d8c0d2dda11fd4df9db98f1dd5b455a5debba7e9e2d9ebec8cb8")
